...
namespace LLMR.Helpers
{
    public static class ConsoleMessageManager
    {
        ...
        {
            CreateConsoleMessage($"Path: {path}", MessageType.Path);
        }

        public static void LogInfo(string message)
        {
            CreateConsoleMessage(message, MessageType.Info);
        }

        public static void LogError(string message)
        {
            CreateConsoleMessage(message, MessageType.Error);
        }

        public static void LogWarning(string message)
        {
            CreateConsoleMessage(message, MessageType.Warning);
        }

        public static void LogDebug(string message)
        {
            CreateConsoleMessage(message, MessageType.Debug);
        }

        public static void LogPythonStdOut(string message)
        {
            CreateConsoleMessage(message, MessageType.PythonStdOut);
        }

        public static void LogPythonStdErr(string message)
        {
            CreateConsoleMessage(message, MessageType.PythonStdErr);
        }
